	...
	function() {
		...
		;(j.bind = function(n, t) {
			...
			(j.partial = function(n) {
				...
				return function() {
					for (
						var r = 0, e = t.slice(), u = 0, i = e.length;
						i > u;
						u++
					)
			...
			(j.mixin = function(n) {
				A(j.functions(n), function(t) {
					...
					j.prototype[t] = function() {
						var n = [this._wrapped]
						return (
							a.apply(n, arguments), z.call(this, r.apply(j, n))
						)
					}
				})
			})
	...
	(function(t, e) {
		...
		i.extend(g.prototype, u, {
			...
			remove: function(t, e) {
				...
				for (s = 0, n = t.length; s < n; s++)
					(o = t[s] = this.get(t[s])) &&
						...
						this.length--,
						e.silent ||
							((e.index = a), o.trigger('remove', o, this, e)),
			...
			get: function(t) {
				if (null != t)
					return (
						this._byId[t] || this._byId[t.id] || this._byId[t.cid]
					)
			},
			at: function(t) {
			...
			create: function(t, e) {
				if (
					((e = e ? i.clone(e) : {}), !(t = this._prepareModel(t, e)))
				)
					return !1
				e.wait || this.add(t, e)
				var r = this,
		...
		i.extend(w.prototype, u, {
			...
			(e.sync = function(t, r, s) {
				...
				if (
					...
					s.emulateHTTP &&
						('PUT' === n || 'DELETE' === n || 'PATCH' === n))
				) {
					;(a.type = 'POST'), s.emulateJSON && (a.data._method = n)
					var o = s.beforeSend
					s.beforeSend = function(t) {
						if (
							(t.setRequestHeader('X-HTTP-Method-Override', n), o)
						)
			...
			i.extend(N.prototype, u, {
				...
				start: function(t) {
					...
					var r = this.getFragment(),
						...
						n =
							P.exec(navigator.userAgent.toLowerCase()) &&
							(!s || s <= 7)
					if (
	...
	(function() {
		...
		;(t.version = '0.5.3'),
			...
			(t.Vector.prototype.insert = function(e, n) {
				...
				if (!i)
					return (
						(this.list = new t.Vector.Node(e, n, i)), this.length++
					)
				for (var o = i, r = i.next; void 0 != r; ) {
					if (e < r.idx)
						return (
							(o.next = new t.Vector.Node(e, n, r)), this.length++
						)
					;(o = r), (r = r.next)
				}
	...
	var MenuHighlight = (function(_super) {
		...
		return (
			...
			(MenuHighlight.prototype.onScroll = function(scrollTop) {
				...
				for (
					;
					index < count && anchors[index + 1].position < scrollTop;
